...
export default function VHProfile() {
  ...
  useEffect(() => {
    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        console.error('Failed to load VH profile:', error);
    ...
    return (
      <div className="po-profile-loading-page">
        <div className="po-profile-loading-card">
          ...
          <span>
            Your Head of Digital Factory profile information could not be
            retrieved.
          </span>
          ...
          <div className="po-header-right">
            ...
            >
              ...
              <div className="po-user-details">
                ...
                <span>Head of Digital Factory</span>
              </div>
          ...
          <div className="po-content">
            ...
            <div className="po-profile-page-heading">
              <div>
                ...
                <p>
                  Review your Head of Digital Factory account and employment
                  information.
                </p>
              </div>
            </div>
