...
export default function ProjectDetails() {
  ...
  const loadProject = () => {
  // "create" is not a valid PO project ID.
  // Send the user back to the PO projects page instead of calling the API.
  if (String(id).toLowerCase() === 'create') {
    navigate('/po/projects', { replace: true });
    return;
  }
            ...
            {isAwaitingReview && (
              <section className="po-review-notice">
                ...
                <div>
                  ...
                  <p>
                    Review the submitted business information, requirements,
                    documentation and project timeline before moving to
                    resource planning.
                  </p>
                </div>
                ...
                <section className="po-project-side-card">
                  ...
                  {isAwaitingReview ? (
                    ...
                    <div className="po-review-status completed">
                      ...
                      <span>The current project status is {status}.</span>
                    </div>
                  )}
                </section>
              </aside>
